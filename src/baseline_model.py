...
def main():
    """Train a baseline RandomForest classifier and evaluate it on the global test split.

    Loads data, fits a scaler, trains the model, and saves classification
    metrics (accuracy, F1) to the results directory.
    """
